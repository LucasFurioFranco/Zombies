...
*/
	...
	if(interest_path){
		...
		for(i=0;i<this.interest_point.length;i++){
			ctx.beginPath();
			ctx.moveTo(this.interest_point[0], this.interest_point[1]);
...
function draw_GUI(){
	...
	ctxGUI.fillText("interest_point: (" + Math.floor(zombie_info.interest_point[0]) + " " + Math.floor(zombie_info.interest_point[1]) + ")", 20, 240);
