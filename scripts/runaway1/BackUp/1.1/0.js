...
function draw_GUI(){
	...
	//Recarga
	ctxGUI.fillText("recharge time: " + Math.round(30*players[0].shootTimer/6000), 20, 90);
	...
	//Ângulo
	ctxGUI.font="20px Georgia";
	ctxGUI.fillText("lookAt:" + players[0].lookAt, 20, 150);

	//Ângulo
	ctxGUI.font="20px Georgia";
	ctxGUI.fillText("zombie kills:" + players[0].nKills, 20, 180);
