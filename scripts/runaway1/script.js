...
function draw_GUI(){
	...
	//Contagem de zumbis mortos pelo player
...
function initMap(){
	...
	var obj;
	obj = ( new Object("CopCar", 0, [300.0, 125.0], 0.785, [186, 96]) );
	obj.boundingBoxes[0] = [[-98, -48],[98, 48]];
	maps[0][0].objects.push(obj);

	obj = ( new Object("SpecialAgentCar", 0, [355.0, 260.0], -0.785, [186, 90]) );
